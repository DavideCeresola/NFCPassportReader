...
extension Parsers {
    struct TD3: Parser {
        ...
        func parse(mrzLines: [String], using formatter: MRZFieldFormatter) -> [MRZResult] {
            ...
            // MARK: Check Digit
            var allCheckDigitsValid = TD3.validateCheckDigits(
            ...
            if formatter.ocrCorrection,
               let correctedDocuments = applyDocumentNumberCorrection(documentNumber: documentNumber,
                   ...
                   TD3.validateCheckDigits(documentNumber: $0,
                                           birthdate: birthdate,
                                           expiryDate: expiryDate,
                                           personalNumber: personalNumber,
                                           finalCheckDigit: finalCheckDigit)
            ...
            // MARK: Result
            return documentNumberCandidates.map {
                .genericDocument(.init(
                    ...
                    documentNumber: $0.value as! String,
        ...
        // MARK: Private
        private static func validateCheckDigits(documentNumber: MRZField, birthdate: MRZField, expiryDate: MRZField, personalNumber: MRZField, finalCheckDigit: MRZField?) -> Bool {
